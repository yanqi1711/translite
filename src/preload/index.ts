...
const api = {
  ...
  onPrefillAndTranslate: (callback: (payload: { text: string, autoTranslate: boolean }) => Promise<void>) => {
    ipcRenderer.on('prefill-and-translate', (_event, payload) => callback(payload))
  },
}
